...
def scrape_screener_data(symbol):
    ...
    current_pe = fy23_pe = median_roce = sales_growth_ttm = sales_growth_3yr = sales_growth_5yr = sales_growth_10yr = "N/A"
...
current_pe, fy23_pe, median_roce, sales_growth_ttm, sales_growth_3yr, sales_growth_5yr, sales_growth_10yr = scrape_screener_data(symbol)
